<style>
  .useApproval .ivu-table-cell{
    padding-left: 0 !important;
    padding-right: 0 !important;
  }
  .useApproval .ivu-checkbox-wrapper{
    margin-right: 0 !important;
  }
  .useApproval .ivu-card-head{
    background: #38ADFF;
    color: #fff;
  }
  .useApproval .button{
  ...
  .useApprovalMotal .table{
    width: 100%;
    border: 1px solid #DDDEE1;
  }
  .useApprovalMotal .table thead{
    background: #F8F8F9;
  }
...
<template>
  <div class="useApproval">
    <Card>
      <p slot="title" style="text-align: center;color: #fff">办公用品领用审批</p>
