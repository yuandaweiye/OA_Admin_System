<style>
  .monthApproval .ivu-table-cell{
    padding-left: 0 !important;
    padding-right: 0 !important;
  }
  .monthApproval .ivu-checkbox-wrapper{
    margin-right: 0 !important;
  }
  .monthApproval .ivu-card-head{
    background: #38ADFF;
    color: #fff;
  }
  .monthApproval .button{
    margin-top: 20px;
    text-align: center;
  }
  .monthApprovalMotal .table{
    width: 100%;
    border: 1px solid #DDDEE1;
  }
  .monthApprovalMotal .table thead{
    background: #F8F8F9;
  }
...
<template>
  <div class="monthApproval">
    <Card>
      <p slot="title" style="text-align: center;color: #fff">月度需求审批</p>
